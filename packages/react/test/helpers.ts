...
/**
 * Creates a mock adapter + widget pair.
 * `getLastRender()` returns the container and callbacks from the most recent
 * `render()` call so tests can simulate provider callbacks.
 */
